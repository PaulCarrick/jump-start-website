...
Rails.application.configure do
  ...
  config.assume_ssl = ENV.fetch("SSL_MODE", "true") == "true"

  # Force all access to the app over SSL, use Strict-Transport-Security, and use secure cookies.
  config.force_ssl = ENV.fetch("SSL_MODE", "true") == "true"
  ...
  config.action_mailer.default_url_options = { host: ENV.fetch("SERVER_HOST", "jumpstartserver.com") }
  ...
  Rails.application.routes.default_url_options = {
    host: ENV.fetch("SERVER_HOST", "jumpstartserver.com"),
    protocol: ENV.fetch("SERVER_MODE", "https")
  }
end
